	...
	<div style="height:50px;"></div>
		<div id="page-wrapper">
			<div class="container-fluid">
				<div class="row">
			        <div class="col-lg-12">
			            <h1 class="page-header">Quotations Done
                ...
                <tbody>
				<?php
					$cq=mysqli_query($conn,"SELECT * FROM quote join customer on customer.userid = quote.user_id  order by q_date_created desc");
